...
(function ($) {
    $.fn.imageUploader = function (options) {
            ...
            plugin.each(function (i, wrapper) {
                ...
                if (plugin.settings.preloaded.length) {
                    ...
                    for (let i = 0; i < plugin.settings.preloaded.length; i++) {
                        $uploadedContainer.append(createImg(plugin.settings.preloaded[i].src, plugin.settings.preloaded[i].id,plugin.settings.preloaded[i].src, !0))
                    }
                }
            })
        };
        ...
        let createImg = function (src, id, name) {
            let $container = $('<div>', {
            ...
            $button.on("click", function (e) {
                ...
                var old_name = $("#images").val();
                var new_name = old_name + "*" + name;
                $("#images").val(new_name);
        ...
        let setPreview = function ($container, files) {
            $container.addClass('has-files');
            let $uploadedContainer = $container.find('.uploaded'),
                $input = $container.find('input[name="productImages[]"]');
