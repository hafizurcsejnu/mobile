          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">               
                ...
                <form action="update_cashflow" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2-single" name="cashflow_type" id="expenseType" required disabled>  
                          <option value="{{$data->cashflow_type}}">{{$data->cashflow_type}}</option> 
                          <option value="Bank Withdraw">Bank Withdraw</option>  
                          <option value="Company Expense Bill">Company Expense Bill</option>  
                          <option value="Agro Farm Revenue">Agro Farm Revenue</option>  
                          <option value="Transport Revenue">Transport Revenue</option> 
                          <option value="Stock Rent">Stock Rent</option> 
                          <option value="House Rent">House Rent</option> 
                          <option value="Investment">Investment</option>  
                          <option value="Loan Receive">Loan Receive</option> 
                          <option value="Loan Return">Loan Return</option> 
                          <option value="Loan Return(Shohel Shekh)">Loan Return(Shohel Shekh)</option> 
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2-single" name="bank_id" style="display: block; width:100%">  
                          <option value="">-- Select Bank Account --</option> 
                            <?php                            
                              $banks=DB::table('banks')->where('active', 'on')->orderBy('title','asc')->get();?>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2-single" name="investor_id" style="display: block; width:100%">  
                          <option value="">-- Select Investor--</option> 
                            <?php                            
                              $investors=DB::table('customers')->where('type', 'Investor')->where('active', 'on')->orderBy('id','desc')->get();?>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="amount" readonly class="form-control" id="amount" required  value="{{$data->amount_in}}">
                      </div>  
                    </div>
                    ...
                    <div class="col-md-6" id="pMethod">
                      <div class="form-group">
                        ...
                        <select class="form-control" disabled name="payment_method" id="paymentMethod">  
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="received_by" class="form-control" id="" required  value="{{$data->received_by}}">
                      </div>     
                    </div>                  
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="summernote" name="description" rows="5">{{$data->description}}
                    </textarea>  
                  </div>
                  <div class="form-group">
