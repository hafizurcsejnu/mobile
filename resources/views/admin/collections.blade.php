          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">
				...
				<a href="add-collection" class="btn btn-white px-3 text-95 radius-round border-2 brc-black-tp10 float-right">
                      ...
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td>
                          <?php if($item->thumbnail!=null) {?>
                              <img src="{{ URL::asset('storage/app/public/'.$item->thumbnail.'') }}" alt=""  height="50px" width="50px;">
                          <?php }elseif($images = $item->images) {
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-collection/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-collection/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                              ...
                              <div class="modal-dialog modal-dialog-centered modal-confirm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="" class="btn btn-danger delete-collection">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>                              
