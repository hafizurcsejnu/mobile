          ...
          <div role="main" class="main-content">
            <div class="page-content container container-plus">
                ...
                <div class="row">
                  ...
                  <div class="col-md-@if($settings->product_type == 'Service'){{4}} @else{{4}}@endif">
                    <div class="form-group">
                ...
                <div class="row content" id="row_1">
                  <div class="col-md-2">
                    <div class="form-group">
                      <select class="select2-single product" name="product_id[]" id="productId_1" style="width: 100%;">
                        <?php                            
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <select class="select2-multiple product_sn" name="product_sn[]" multiple="multiple" id="productSn_1" style="width: 100%; height: 50px;"> 
                      </select>                     
                    </div>
                  </div>
                  <div class="col-md-1">
...
<script>
  $(document).ready(function () {
    ...
    $(document).on('click', '#addRow', function (event) {
      ...
      html += '<div class="col-md-4"><div class="form-group"><select class="select2-multiple product_sn" name="product_sn[]" multiple="multiple" id="productSn_' + i +'" style="width: 100%; height: 50px;"></select></div></div>';
    ...
    $(document).on('change', '.product', function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          $('#qty' + row_id + '').val(1);
          //$('#productSn_' + row_id + '').prepend("<option value='"+ response.data.id+ "' selected='selected'>" + response.serials.product_sn + "</option>"); 
          //$('#sub_category_id').focus;  
          $.each(response.serials, function(key, value){
            $('#productSn_' + row_id + '').append('<option value="'+ value.product_sn +'">' + value.product_sn+ '</option>');
          });
