            ...
            <div class="page-content container container-plus">
              ...
              <form action="store_invoice" method="post" enctype="multipart/form-data">
                ...
                <div class="row content" id="row_1">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <input type="text" style="padding: 0px 3px" name="price[]" id="unitPrice1" class="form-control price">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                ...
                padding-top: 4px;margin-top: -10px;margin-bottom: 10px;">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <input type="text" name="coupon_code" placeholder="Enter coupon" class="form-control" id="coupon_code">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <input type="text" readonly name="net_amount" class="form-control tr" id="net_amount" value="0">
                    </div>
                  </div>
                  <div class="col-md-2"></div>
                </div>
...
<script>   
  $(document).ready(function () {
    ...
    $(document).on('change', '#customerId', function () {
      ...
      if (customerId == 'New') {
        var textMore =
          "<input type='text' autofocus class='form-control mb-2 mt-1' placeholder='Enter new patient name' name='customer_name' id='customerName'/>";
