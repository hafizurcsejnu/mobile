              ...
              <div class="page-content container container-plus">               
                ...
                <form method="POST"  action="{{route('save_product')}}" enctype="multipart/form-data">
                  ...
                  <div class="row"> 
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="" required  placeholder="Enter Product Title">
                      </div>  
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="">MSRP<span></span></label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control select2-single" name="brand" id="">
                          @if($last_item != null)
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="">Size/Model<span></span></label>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="">Grade/Material/Color</label>        
                        <select class="form-control select2-single" name="particular" id="">
                          <option value="">Select one</option> 
                            @php                  
                            $mu = DB::table('data_lookups')
