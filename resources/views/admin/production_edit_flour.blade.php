                    ...
                    @if($pd_count != 0)
                      @foreach($product_details as $pd)                    
                        <div id="row_{{$loop->iteration}}" class="row content">
                          ...
                          <div class="col-md-1">
                            <div class="form-group">
                              <input type="text" name="price[]" value="{{$pd->qty}}" id="unitPrice1" class="form-control price qty">
                            </div>
                          </div>
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text" name="total_price[]" value="{{$pd->total_qty}}" readonly class="form-control amount tr" id="amount1">
                            </div>
                          </div>                     
    ...
    $(document).ready(function () {
      ...
      $(document).on('click', '#addRow', function (event) {
        ...
        html +=
          ...
          i + '" class="form-control price qty"></div></div>';  
