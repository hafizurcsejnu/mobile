          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">
                ...
                <h1 class="page-title text-primary-d2 text-140">Productions </h1>     
                <a href="add-production" class="btn btn-white px-3 text-95 radius-round border-2 brc-black-tp10 float-right">
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                          ...
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Production Title/House No</th>				
                          							
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm tr"> Total Qty</th>						
                    ...
                    @foreach($data as $item)                                   
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td><a  title="Edit" href="edit-production/{{$item->id}}">{{$item->title}}</a></td>                       
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-production/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-production/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                              ...
                              <div class="modal-dialog modal-dialog-centered modal-confirm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="" class="btn btn-danger delete-production">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>                              
