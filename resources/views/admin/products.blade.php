            ...
            <div role="main" class="main-content">
              <div class="page-content container container-plus">
                <div
                  ...
                  <h1 class="page-title text-primary-d2 text-140">{{$settings->product_type}}s</h1>
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <tbody class="pos-rel">
                      ...
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="d-none"><a href="{{URL::to('edit-product')}}/{{$item->id}}" target="_blank">
                        ...
                        <td><a href="{{URL::to('edit-product')}}/{{$item->id}}" target="_blank" title="">{{$item->name}}</a> </td>
                        <td>{{$item->catName}}</td>
                        @php
