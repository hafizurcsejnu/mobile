...
<style>
  ...
  <div class="page-content container container-plus">
    <div class="page-header pb-2">
      ...
      <a href="{{URL::to('add-purchase')}}" class="btn btn-white px-3 text-95 radius-round border-2 brc-black-tp10 float-right">
              ...
              <div class="page-content container container-plus">               
                ...
                <form action="update_purchase" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2-single" name="company_id" id="">  
                                ...
                                <?php                            
                                $companies=DB::table('companies')->where('company_type', 'Company')->where('client_id', session('client_id'))->where('active', 'on')->orderBy('title','asc')->get();
                                ?>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="supplier_id">  
                            @if ($data->supplier_id != null)
                              <?php 
                              $item = DB::table('companies')->where('id', $data->supplier_id)->first();?>  
                              @if ($item)
                              <option value="{{$item->id}}">{{$item->title}}</option> 
                              @endif 
                            @endif  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="transport_cost" class="form-control" id=""  value="{{$data->transport_cost}}">
                      </div>      
                    </div>
                  ...
                  <div class="purchase_details mt-5">
                    ...
                    <?php 
                       $product_details = DB::table('purchase_details')  
                        ...
                        foreach($product_details as $pd){
                          ...
                          $total_purchase = $total_purchase + $pd->total_price;
                        }     
                        //dd($total_purchase);                                       
                    ?>
                    @if($pd_count != 0)
                      @foreach($product_details as $pd)                    
                        <div id="row_{{$loop->iteration}}" class="row content">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text" name="qty[]" value="{{$pd->qty}}" id="qty1" class="form-control qty">
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text" name="price[]" value="{{$pd->price}}" id="unitPrice1" class="form-control price">
                            </div>
                          </div>
                        
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text" name="total_price[]" value="{{$pd->total_price}}" readonly class="form-control amount tr" id="amount1">
                            </div>
                          </div>                     
                    ...
                    <div class="row">
                      ...
                      <a href="{{URL::to('purchases')}}" class="btn btn-default">Cancel</a>
