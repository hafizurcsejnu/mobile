          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">
                ...
                <h1 class="page-title text-primary-d2 text-140">Purchases </h1>     
                <a href="add-purchase" class="btn btn-white px-3 text-95 radius-round border-2 brc-black-tp10 float-right">
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                          ...
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Purchase Title</th>				
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm"> Company</th>								
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm"> Suplier</th>								
                          <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm tr"> Total Price</th>						
                    ...
                    @foreach($data as $item)                                   
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td>{{$item->date}}</td>
                        <td><a  title="Edit" href="edit-purchase/{{$item->id}}">{{$item->title}}</a></td>                       
                         ...
                         <td> 
                          <?php 
                          if ($item->supplier_id) {
                          $supplier = DB::table('companies')->where('id', $item->supplier_id)->first();
                          if($supplier){
                            echo $supplier->title; 
                          }
