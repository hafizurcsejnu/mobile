          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">
                ...
                <a href="add-return"class="btn btn-default px-3 text-95 radius-round border-2 brc-black-tp10 float-left">
                  <i class="fa fa-plus mr-1"></i>
                  <span class="d-sm-none d-md-inline">New</span> Return
                </a>
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                        ...
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm" style="width: 12%"> Date </th>
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm"> Inv ID </th>	
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm" style="width: 15%"> Customer </th>                        
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm" style="width: 10%"> Mobile </th>                        
                        ...
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm" style="width: 8%"> Due </th>                        
                    ...
                    @foreach($order as $order)                                   
                      <tr class="d-style bgc-h-default-l4">  
                        ...
                        <td> <a  title="Details" href="invoice-preview/{{$order->id}}" target="_blank">INV-{{$order->inv_id}} </a></td>
                        ...
                        <td class="text-danger tr">
                          ...
                          @php
                              if (is_float($order->due_amount) || is_int($order->due_amount)) {
                               echo number_format($order->due_amount, 2);
                              }else{
                                echo $order->due_amount;
                              }
                          @endphp
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a href="invoice-preview/{{$order->id}}" title="Invoice" target="_blank" class="v-hover">
