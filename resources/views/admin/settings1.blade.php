            ...
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">               
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Inv Logo Size</label>
                      <input type="text" name="inv_logo_size" class="form-control" id=""  value="{{$data->inv_logo_size}}">
                    </div> 
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Inv Title Size</label>
                      <input type="text" name="inv_title_size" class="form-control" id=""  value="{{$data->inv_title_size}}">
                    </div> 
                  </div> 
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Inv Sub Title Size</label>
                      <input type="text" name="inv_sub_title_size" class="form-control" id=""  value="{{$data->inv_sub_title_size}}">
                    </div> 
                  </div> 
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Inv Address Size</label>
                      <input type="text" name="inv_address_size" class="form-control" id=""  value="{{$data->inv_address_size}}">
                    </div> 
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">Nav Logo Size</label>
                      <input type="text" name="nav_logo_size" class="form-control" id=""  value="{{$data->nav_logo_size}}">
                    </div> 
                  </div>   
                   
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">product_ob</label>
                      <input type="text" name="product_ob" class="form-control" id=""  value="{{$data->product_ob}}">
                    </div> 
                  </div>
                    
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">company_ob</label>
                      <input type="text" name="company_ob" class="form-control" id=""  value="{{$data->company_ob}}">
                    </div> 
                  </div>

                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="">customer_ob</label>
                      <input type="text" name="customer_ob" class="form-control" id=""  value="{{$data->customer_ob}}">
                    </div> 
                  </div>  
