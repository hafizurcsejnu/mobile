                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                        ...
                        @if (session('client_id') == 1)
                          <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Client </th>                             
                        @endif
                        <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Email</th>  
                        <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">User Type</th> 
                        <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Start From</th> 
                    ...
                    <tr class="d-style bgc-h-default-l4">
                      <td class="pl-3 pl-md-4 align-middle pos-rel"> {{$loop->iteration}} </td>
                        ...
                        @if (session('client_id') == 1)
                          <td> <span class="text-105"> {{$item->client_id}} </span> </td>                         
                        @endif
                        <td> <span class="text-105"> {{$item->email}} </span> </td>
                        <td> <span class="text-105"> {{$item->user_type}} </span> </td>
