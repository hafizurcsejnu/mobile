    ...
    <div class="container">
        <div class="product-details-top mb-2">
            ...
            <div class="container product-details-tab">
                <ul class="nav nav-pills justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false">All Products</a>
                    </li>
                    {{-- <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="product-info-tab" role="tabpanel" aria-labelledby="product-info-link">
                        <div class="product-desc-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>{{$loop->iteration}}. <a href="{{URL::to('product')}}/{{$product->slug}}" target="_blank">{{$product->name}}</a> </h3>
                                </div>
                                <div class="col-md-6">
                                    <h3>${{$product->price}}</h3>
                                </div>                                                     
            ...
            @if ($products->count() != 0)
                <h2 class="title1 text-center mb-4">You May Also Like</h2>            
            ...
            <div class="owl-item ymal active" style="width: 300px!important; margin-right: 20px;">
                <div class="product product-2">
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a href="{{URL::to('collection')}}/{{$item->slug}}">{{$item->name}}</a></h3>
                        <!-- End .product-title -->
                        <div class="product-price">
                            ${{$item->price}}
                        </div>
     ...
     @endforeach
                ...
                <div class="owl-dots disabled">
                    ...
                    <button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>
