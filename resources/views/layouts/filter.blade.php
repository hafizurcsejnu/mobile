                            ...
                            <div class="collapse hide" id="widget-4">
                                <div class="widget-body" style="padding-bottom: 0rem;">
                                    <div class="filter-items">
                                        ...
                                        @php $collection = \App\Models\DataLookup::where('data_type','Brand')->get();  @endphp
                                        @foreach($collection as $item)
                                        <div class="filter-item brand_item"  style="width: 50%; float: left;">
                                            <div class="custom-control custom-checkbox">
                ...
                $.get('?page='+page,{
                    ...
                    if(!data_status){
                        items.forEach(element => {
                            ...
                            var html = '<div class="col-6 col-md-4 col-lg-4 col-xl-2"> <div class="product product-2" data-count=":popularity_count"> <figure class="product-media">:image_code<div class="product-action-vertical"> :wishlist </div><div class="product-action product-action-dark">  <a href="javascript:void(0)" id="atc:id" class="btn-product btn-cart addToCart :cart" data-id=":id"><span>Add to cart</span></a> <a href=":quick_view_url" class="btn-product btn-quickview" title="Quick view"><span>Quick view</span></a> </div></figure><div class="product-body"> <div class="product-cat"></div><h3 class="product-title"><a href=":product_url" target="_blank">:name</a></h3><div class="product-price"> $:price </div> </div></div> </div>';
                            // time difference 
                            ...
                            if(thumbnail){
                                var image_src = "{{asset('storage/app/public/')}}/"+thumbnail;
