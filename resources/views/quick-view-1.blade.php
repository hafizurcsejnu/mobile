	...
	<div class="quickView-content">
		<div class="row">
				...
				<div class="row">
					<div class="product-left">					
						...
						?>
						 ...
						 <div id="product-zoom-gallery" class="product-image-gallery" style="overflow-y: scroll;overflow-x:hidden; direction: rtl; height:565px;">
							<div class="scroll_bar_inside" style="direction: ltr;">                               
								...
								?>
                                    ...
                                    <a href="#<?php echo $i;?>"  style="direction:ltr;" class="carousel-dot <?php if($i==0){echo "active";} ?> pdt_thumb_quick">
			...
			<div class="col-lg-4 col-md-4" style="margin-left: -30px;">
				...
				<h3 class="product-price">Price: ${{$item->price}}</h3>
                ...
                <div class="product-details-footer text-center">
                        ...
                        <span>Category:</span>
							<?php 
								$category = DB::table('product_categories') 
									...
									->first(); 
							?>
							<a href="{{URL::to('3dmodels-category')}}/{{$category->id}}">{{$category->name}}</a>
                   		 </div>
