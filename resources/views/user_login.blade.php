...
<html lang="en">
  ...
  <head>
    ...
    <title>Login | Business Solution</title>
   ...
   <!-- favicon -->
   <link rel="icon" type="image/png" href="https://biz.ordevs.com/images/favicon.png" />  
                    ...
                    <div id="loginBgCarousel" class="carousel slide minw-100 h-100" style="background-color: #ecf4fc !important;">
                      ...
                      <div class="carousel-inner minw-100 h-100">
                        <div class="carousel-item active minw-100 h-100">
                          ...
                          <div class="px-3 bgc-blue-l4 d-flex flex-column align-items-center justify-content-center" style="margin-top: 50px">
                            <a class="mt-5 mb-2" href="{{URL::to('/')}}">
                              @if (ENV('APP_ENV') == 'local')
                                  <img src="{{asset('images/logo.png')}}" alt="logo" style="width: 250px;">
                              @else 
                                 <img src="https://biz.ordevs.com/images/logo.png" alt="logo" style="width: 200px;">
                              @endif 
                            </a>                          
                            ...
                            <div class="mt-5 mx-4 text-dark-tp3 text-center">
                              ...
                              <span class="text-100" style="font-size: 1.0rem">    
                                {{$settings->sub_title}}
                              </span>
                              <br>
                              <br>
                            ...
                            <div class="mt-auto mb-4 text-dark-tp2">
                              <a href="" target="https://ordevs.com/">orDevs &copy; {{date("Y")}}</a> 
                            </div>
                          </div>
                        </div> 
                        ...
                        <div class="carousel-item minw-100 h-100">
                          ...
                          <div class="d-flex flex-column align-items-center justify-content-start">
                            ...
                            <a class="mt-5 mb-2" href="">
                              <img src="{{ URL::asset('storage/app/public/'.$settings->logo_header.'') }}" width="250px" alt="Logo">
                            </a>    
{{-- 
                        ...
                        <div class="carousel-item minw-100 h-100">
                          <div class="d-flex flex-column align-items-center justify-content-start">
                            <div class="bgc-black-tp4 radius-1 p-3 w-90 text-center my-3 h-100">
                              <a class="mt-5 mb-2" href="">
                                <img src="{{ URL::asset('storage/app/public/'.$settings->logo_header.'') }}" width="250px"  alt="">
                              </a>       
                        ...
                        <form action="access-user" method="post" autocomplete="off" class="form-row mt-4">
                          ...
                          <label class="floating-label text-grey-l1" for="id-login-username">
                            ...
                            <div class="d-flex align-items-center input-floating-label1 text-blue brc-blue-m2">
                               ...
                               <input type="text" name="email" class="form-control form-control-lg pr-4 shadow-none" id="id-login-username" />
